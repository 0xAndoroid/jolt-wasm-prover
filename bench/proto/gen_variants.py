"""Generates the unrolled V2-family kernels.
    ...
    uv run python bench/proto/gen_variants.py      # rewrites frontend/public/wgsl/commit/commit_accumulate.wgsl (= VARIANTS[BEST])
...
KERNELS = HERE.parents[1] / "frontend" / "public" / "wgsl" / "commit"
...
if __name__ == "__main__":
    (KERNELS / "commit_accumulate.wgsl").write_text(source(BEST))
